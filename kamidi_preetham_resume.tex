...
\section{Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      {Safekids}{Remote}
      {Software Development Engineer}{Febrary 2021 - June 2021}
      \resumeItemListStart
      \resumeItem{Parental Control Application}
        {Developed backend and frontend services to support desktop parental control application; handled user management, subscriptions, payments and reporting. \\Tech Stack:\textbf{ Nodejs, AWS, SQS, S3, MongoDB, Stripe, Reactjs }}
      \resumeItemListEnd
    \resumeSubheading
      ...
      \resumeItem{Scanning Application}
        {Application developed to scan and verify user tickets at events. Designed and developed ticket verification system which takes qrcode as input and verifies if the user's ticket is valid/invalid based on transaction data. \\Tech Stack:\textbf{ Go, MongoDB }}
      \resumeItem{Barcode Generator}
        {Designed and developed a barcode generator which automatically generates barcodes for an event hosted on the platform based on business constraints. \\Tech Stack:\textbf{ Go, MongoDB, Kafka }}
      \resumeItem{Content Management System}
        {Application developed for generating content as well as business constraints for a live event. Integrated messaging queue into the system to propagate data to other dependent systems, implemented archival mechanism to safely archive data without affecting any business constraints. \\Tech Stack:\textbf{ Go, Kafka, MongoDB, Redis }}
      \resumeItemListEnd
    \resumeSubheading
      {Abzooba India}{Pune}
...
\section{Personal Projects}
  \resumeSubHeadingListStart
    \resumeSubItem{\href{https://github.com/notAI-tech/verifytweet}{Verify Tweet}}
      {A cli tool written in Python to verify authenticity of a tweet produced from a meme template.}
    \resumeSubItem{\href{https://github.com/preetham/greenhub}{Greenhub}}

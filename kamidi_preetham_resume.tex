...
\section{Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      {Safekids}{Remote}
      {Software Development Engineer}{Febrary 2021 - Present}
      \resumeItemListStart
      \resumeItem{Parental Control Application}
        {Application developed to support parental control application deployed on desktops; handled user management, subscriptions, reporting. \\Tech Stack:\textbf{ Nodejs, MongoDB }}
      \resumeItemListEnd
    \resumeSubheading

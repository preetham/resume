...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    {Product Engineer II}{August 2021 - Present}
    \resumeItemListStart
    \resumeItem{Noon Plus}
      {Designed a subscription model for Noon's offerings including architecture, developed an entirely new microservice in Java which deals with subscription management. \\Tech Stack:\textbf{ Java, MySQL, Kafka, Redis }}
    \resumeItem{Payment Aggregator Integration}
      {Integrated a new payment aggregator into Noon's supported payment methods. Lead the project right from problem identification, solutioning, technical design to implementation. \\Tech Stack: \textbf{ NodeJS, MySQL }}
    \resumeItemListEnd
    \resumeSubheading
      {Safekids}{Remote}

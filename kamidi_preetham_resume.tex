  ...
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItem{Parental Control Application}
        {Application developed to support parental controls for kids on desktops; handled user management, subscriptions, reporting. \\Tech Stack:\textbf{ Nodejs, MongoDB }}
      \resumeItemListEnd
    \resumeSubheading

...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeItem{Noon Plus}
      {Designed a subscription version of Noon's offerings, developed a new service which deals with subscription management. \\Tech Stack:\textbf{ Java, MySQL }}
    \resumeItem{Search Revamp}
      {Fixed existing search logic to enable multi entity search: Groups, Teachers and Subjects.  \\Tech Stack: \textbf{ NodeJS, Elastic }}
    \resumeItemListEnd
    \resumeSubheading
      {Safekids}{Remote}
